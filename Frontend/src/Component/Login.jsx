...
const loginApi = async()=>{
    ...
    try{
        ...
        if(response.status=== 201){
            console.log('Login suceessfully',response.data);
            navigate('/dashboard');
        }
    } catch(error){
    ...
    return (
        ...
        >
            <motion.div
                className="bg-white shadow-yellow-400 text-gray-800 p-8 rounded-2xl shadow-2xl w-full max-w-md"
                ...
                <form onSubmit={handleSubmit} >
                    <div className='mb-6'>
                        ...
                        <input
                            type="email"
                            id='email'
                            className='w-full px-3 py-2 text-gray-700 border rounded-lg focus:outline-none focus:border-yellow-400'
                            value={email}
